...
export default function Footer() {
  ...
  return (
    <nav
      className="fixed bottom-0 left-0 right-0 flex md:hidden flex-row items-center justify-between h-[91px] px-[33px] pt-3 pb-6 rounded-t-[24px] z-50 max-w-md mx-auto"
      style={{
